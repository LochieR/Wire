...
namespace Wire {
							 ...
							 double streamTime, RtAudioStreamStatus status, void* userData)
	{
		...
		AudioEngine::AudioData* data = (AudioEngine::AudioData*)userData;
	...
	std::thread AudioEngine::m_AudioThread;
	bool AudioEngine::m_AudioThreadRunning = true;

	bool AudioEngine::m_SceneRuntime = false;
