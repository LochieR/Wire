...
namespace wire {
    ...
    VulkanFont::VulkanFont(Renderer* renderer, const std::filesystem::path& path, std::string_view debugName, uint32_t minChar, uint32_t maxChar)
        : m_Renderer(renderer), m_DebugName(debugName)
    {
...
#define THREAD_COUNT 8
        ...
        m_AtlasTexture = m_Renderer->createTexture2D(naive.AtlasData, naive.Width, naive.Height, m_DebugName);
