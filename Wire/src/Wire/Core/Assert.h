...
#include <filesystem>
	...
	#define WR_INTERNAL_ASSERT_NO_MSG(type, check) WR_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", WR_STRINGIFY_MACRO(check), std::filesystem::path(__FILE__).string(), __LINE__)
